        ...
        <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg border border-slate-200">
            ...
            <div class="bg-slate-50 border-b border-slate-200 p-4 flex justify-between items-center rounded-t-lg">
                ...
                <div class="flex space-x-2">
                    ...
                    <span class="text-[10px] font-bold bg-slate-200 text-slate-600 px-2 py-1 rounded uppercase tracking-wider">v1.4</span>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('store_product') }}" method="POST" class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-600 uppercase mb-1">Descrição Comercial / Detalhes</label>
                    ...
                    <div class="pt-4 border-t border-slate-100">
                        ...
                        <div x-show="!novoFornecedor" x-transition>
                            <select name="idSupplier" class="w-full px-3 py-2 rounded border border-slate-300 bg-slate-50 text-sm outline-none focus:border-indigo-500">
                                ...
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->id }}">{{ $supplier->company_name }} - {{ $supplier->cnpj }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div x-show="novoFornecedor" x-transition class="space-y-6">
                            <div class="bg-indigo-50/30 p-5 rounded-lg border border-indigo-100 space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="company_name" :required="novoFornecedor" class="w-full px-3 py-2 rounded border border-indigo-200 text-sm outline-none bg-white">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-indigo-900 uppercase mb-1">Nome Fantasia</label>
                                        <input type="text" name="trade_name" class="w-full px-3 py-2 rounded border border-indigo-200 text-sm outline-none bg-white">
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-[10px] font-bold text-indigo-900 uppercase mb-1">CNPJ</label>
                                        <input type="text" name="cnpj" :required="novoFornecedor" class="w-full px-3 py-2 rounded border border-indigo-200 text-sm outline-none bg-white" placeholder="00.000.000/0001-00">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-indigo-900 uppercase mb-1">Inscrição Estadual</label>
                                        <input type="text" name="state_registration" class="w-full px-3 py-2 rounded border border-indigo-200 text-sm outline-none bg-white">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-50 p-5 rounded-lg border border-slate-200 space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">E-mail</label>
                                        <input type="email" name="email" :required="novoFornecedor" class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none bg-white">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">Telefone</label>
                                        <input type="text" name="phone" :required="novoFornecedor" class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none bg-white" placeholder="(71) 00000-0000">
                                    </div>
                                    <div>
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">Pessoa de Contato</label>
                                        <input type="text" name="contact_name" class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none bg-white">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-50 p-5 rounded-lg border border-slate-200 space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="text" name="zip_code" :required="novoFornecedor" class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none focus:border-blue-500 bg-white shadow-sm" placeholder="00000-000">
                                    </div>
                                    <div class="md:col-span-3">
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">Logradouro</label>
                                        <input type="text" name="street" :required="novoFornecedor" class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none focus:border-blue-500 bg-white shadow-sm">
                                    </div>
                                    <div class="md:col-span-1">
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">Nº</label>
                                        <input type="text" name="number" :required="novoFornecedor" class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none focus:border-blue-500 bg-white shadow-sm">
                                    </div>
                                    <div class="md:col-span-3">
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">Complemento</label>
                                        <input type="text" name="complement" class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none bg-white shadow-sm" placeholder="Apto, Sala, Galpão...">
                                    </div>
                                    <div class="md:col-span-3">
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">Bairro</label>
                                        <input type="text" name="neighborhood" :required="novoFornecedor" class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none bg-white shadow-sm">
                                    </div>
                                    <div class="md:col-span-4">
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">Cidade</label>
                                        <input type="text" name="city" value="Salvador" required class="w-full px-3 py-2 rounded border border-slate-300 text-sm outline-none bg-white shadow-sm">
                                    </div>
                                    <div class="md:col-span-2">
                                        <label class="block text-[10px] font-bold text-slate-600 uppercase mb-1">UF</label>
                                        <input type="text" name="state" value="BA" maxlength="2" required class="w-full px-3 py-2 rounded border border-slate-300 text-sm text-center font-bold bg-white uppercase">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pt-4 border-t border-slate-100">
                        ...
                        <div x-show="addLote" x-transition class="bg-emerald-50/20 p-5 rounded-lg border border-emerald-100 space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-900 uppercase mb-1">Cód. do Lote</label>
                                    <input type="text" name="batch_code" :required="addLote" class="w-full px-3 py-2 rounded border border-emerald-200 text-sm outline-none focus:border-emerald-500 bg-white shadow-sm" placeholder="Ex: LOT-2026/01">
                                </div>
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-900 uppercase mb-1">Data de Fabricação</label>
                                    <input type="date" name="manufacturing_date" :required="addLote" class="w-full px-3 py-2 rounded border border-emerald-200 text-sm bg-white shadow-sm">
                                </div>
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-900 uppercase mb-1">Data de Vencimento</label>
                                    <input type="date" name="expiration_date" :required="addLote" class="w-full px-3 py-2 rounded border border-emerald-200 text-sm bg-white shadow-sm">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-900 uppercase mb-1">Quantidade Inicial</label>
                                    <input type="number" name="quantity" :required="addLote" class="w-full px-3 py-2 rounded border border-emerald-200 text-sm bg-white shadow-sm" placeholder="0">
                                </div>
                                <div>
                                    <label class="block text-[10px] font-bold text-emerald-900 uppercase mb-1">Preço de Custo (Unidade)</label>
                                    <div class="relative">
                                        <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-emerald-400 text-sm font-bold">R$</span>
                                        <input type="text" name="cost_price" :required="addLote" class="w-full pl-9 pr-3 py-2 rounded border border-emerald-200 text-sm font-bold outline-none focus:border-emerald-500 text-emerald-700 bg-white shadow-sm" placeholder="0,00">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-end items-center space-x-4 pt-4 border-t border-slate-100">
                        <button type="reset" class="text-sm font-bold text-slate-400 hover:text-slate-600 transition uppercase tracking-tighter">Limpar Tudo</button>
                        <button type="submit"
